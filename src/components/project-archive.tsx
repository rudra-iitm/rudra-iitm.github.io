  ...
  const projects = [
    {
        ...
        "short_description": "Chess game built with React, TailwindCSS, Websocket, Clerk.",
    ...
    },
    {
      ...
      "short_description": "A productivity hub built with NextJS, TailwindCSS.",
      "github": "https://github.com/Rudra-IITM/note-corner"
    },
    {
      "timeline": "2024",
      "name": "Surge Sync",
      ...
      "short_description": "Deploy your React app effortlessly with just one click.",
      "github": "https://github.com/Rudra-IITM/surgesync"
    },
    {
      "timeline": "2024",
      "name": "My Portfolio",
      ...
      "short_description": "Know everything about me and my projects in one place.",
    ...
    },
    {
      ...
      "short_description": "A mess management system for IIT mandi built with ReactJS, TailwindCSS, Flutter.",
      "github": "https://github.com/Rudra-IITM/MessManagementApp"
    },
  ]
      ...
      <Table>
        <TableHeader>
          <TableRow className="hover:bg-slate-950">
            <TableHead className="w-[100px] text-white hidden md:block">Timeline</TableHead>
            <TableHead className="text-white ">Project</TableHead>
            <TableHead className="text-white max-w-md hidden md:block">Made with</TableHead>
        ...
        <TableBody>
          {projects.map((project, index) => (
            <TableRow key={index} className="hover:bg-slate-900">
              <TableCell className="font-medium text-gray-400 hidden md:block">{project.timeline}</TableCell>
              <TableCell className="text-gray-200 text-sm">{project.name}</TableCell>
              <TableCell className="text-gray-400 md:flex gap-2 flex-wrap max-w-4xl hidden">{project.techs.map( (tech, index) => (
               ...
               <TableCell className="text-gray-400 max-w-xl">
                <div className="block md:hidden">{project.short_description}</div>
                <div className="hidden md:block">{project.description}</div>
              </TableCell>
