...
export const LampContainer = ({
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center mt-40 justify-center isolate z-0">
        <motion.div
      ...
      <div className="relative z-50 flex -translate-y-20 flex-col items-center px-5 mb-20">
        {children}
      </div>
    </div>
  );
