...
const About = ({ className = '' }: { className?: string }) => {
  return (
    <div className={`text-md font-light tracking-widest text-slate-500 group-hover:text-slate-200 group-focus-visible:text-slate-200 ${className}`} style={{ fontFamily: 'Arial, sans-serif'}}>
